...
conv_1 = AveragePooling2D(pool_size=(2, 2), strides=(3, 3), padding="same")(conv_1)
...
conv_2 = AveragePooling2D(pool_size=(2, 2), strides=(3, 3), padding="same")(conv_2)
...
conv_3 = MaxPooling2D(pool_size=(2, 2), strides=(3, 3), padding="same")(conv_3)
...
conv_4 = MaxPooling2D(pool_size=(2, 2), strides=(3, 3), padding="same")(conv_4)
