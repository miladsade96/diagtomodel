...
first_pool = MaxPooling2D(pool_size=(3, 3), strides=2, padding="same")(first_add)
...
second_pool = MaxPooling2D(pool_size=(3, 3), strides=2, padding="same")(second_add)
...
third_pool = MaxPooling2D(pool_size=(3, 3), strides=2, padding="same")(third_add)
...
fourth_pool = MaxPooling2D(pool_size=(3, 3), strides=2, padding="same")(fourth_add)
...
fifth_pool = MaxPooling2D(pool_size=(3, 3), strides=2, padding="same")(fifth_add)
